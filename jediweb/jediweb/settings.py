"""
Django settings for jediweb project.
...
SECRET_KEY = 'kmwv2l4^s+0a4ipvj_6cy8%2*)b-vm@h+wg%ky2tr!hd1iu#a*'
...
WSGI_APPLICATION = 'jediweb.wsgi.application'
